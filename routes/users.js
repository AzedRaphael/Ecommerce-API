...
const {logOutUser, loginUser, registerUser, getUser,verifyLoginCode, updateUser,forgotPassword,changePassword,resetPassword,sendLoginCode, deleteUser, getAllUsers,verificationEmail,verifyUser,loginStatus,upgradeUser,sendAutomatedEmail} = require('../controllers/usersCtrls');
...
router.get("/getAllUsers",authMW, getAllUsers)
